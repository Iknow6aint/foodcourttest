...
export class OrderController {
  ...
  @ApiOperation({
    ...
    description: 'Retrieves all orders along with their related data including logs, calculated order details, order type, and amount history using raw SQL queries.',
  })
  @ApiOkResponse({
  ...
  @ApiOperation({
    ...
    description: 'Finds the meal with the highest total quantity ordered by analyzing the meals data in calculated orders using raw SQL queries.',
  })
  @ApiOkResponse({
  ...
  @ApiResponse({
    status: 500,
    description: 'Internal server error occurred while finding most bought meal',
  })
